...
See https://ionicframework.com/docs/vue/navigation#ionpage for more information.`);
    ...
    render() {
        ...
        return vue.h("ion-router-outlet", { ref: "ionRouterOutlet" }, components &&
            components.map((c) => {
                var _a, _b;
                let props = {
...
const VueDelegate = (addFn = addTeleportedUserComponent, removeFn = removeTeleportedUserComponent) => {
    ...
    const attachViewToDom = (parentElement, componentOrTagName, componentProps = {}, classes) => {
        ...
        const hostComponent = vue.h(vue.Teleport, { to: div }, vue.h(componentOrTagName, Object.assign({}, componentProps)));
        /**
...
const IonToast = /*@__PURE__*/ defineOverlayContainer('ion-toast', ionToast_js.defineCustomElement, ['animated', 'buttons', 'color', 'cssClass', 'duration', 'enterAnimation', 'header', 'htmlAttributes', 'icon', 'keyboardClose', 'layout', 'leaveAnimation', 'message', 'mode', 'position', 'translucent'], components.toastController);
